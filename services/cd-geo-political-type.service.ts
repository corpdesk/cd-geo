...
export class CdGeoPoliticalTypeService {
  logger: Logging;
  b: BaseService<CdGeoPoliticalTypeModel>; // instance of BaseService
  cdToken?: string;
  ...
  async create(req: Request, res: Response) {
    ...
    if (await this.validateCreate(req, res)) {
      ...
      this.logger.logInfo(
        'CdGeoPoliticalTypeService::create()/serviceInput:',
        serviceInput,
      );
  ...
  async createI(
    req,
    res,
    serviceInputExt: IExtServiceInput<CdGeoPoliticalTypeModel>,
  ): Promise<CdGeoPoliticalTypeModel | boolean> {
  ...
  async createM(req: Request, res: Response) {
    ...
    for (var CdGeoPoliticalTypeData of data) {
      ...
      const CdGeoPoliticalTypeQuery: CdGeoPoliticalTypeModel =
        CdGeoPoliticalTypeData;
      ...
      const serviceInputExt: IExtServiceInput<CdGeoPoliticalTypeModel> = {
        serviceInput: si,
        entityData: CdGeoPoliticalTypeQuery,
      };
      let ret = await this.createI(req, res, serviceInputExt);
      this.logger.logInfo('CdGeoPoliticalTypeService::createM()/forLoop/ret:', {
        ret: ret,
      });
    }
  ...
  async CdGeoPoliticalTypeExists(req, res, params): Promise<any> {
  ...
  async read(
    req,
    res,
    serviceInput: IServiceInput<CdGeoPoliticalTypeModel>,
  ): Promise<any> {
    // const serviceInput: IServiceInput<CdGeoPoliticalTypeModel> = {
    //     serviceInstance: this,
    //     serviceModel: CdGeoPoliticalTypeModel,
  ...
  async readSL(
    ...
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalType/q:',
      q,
    );
    try {
  ...
  async validateCreate(req: Request, res: Response) {
    this.logger.logInfo(
      'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/01',
    );
    const svSess = new SessionService();
    ///////////////////////////////////////////////////////////////////
    ...
    if (await this.b.validateUnique(req, res, params)) {
      this.logger.logInfo(
        'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/02',
      );
      if (await this.b.validateRequired(req, res, this.cRules)) {
        this.logger.logInfo(
          'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/03',
        );
        ret = true;
      } else {
        this.logger.logInfo(
          'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/04',
        );
        ret = false;
      ...
      this.logger.logInfo(
        'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/05',
      );
      ret = false;
    ...
    this.logger.logInfo(
      'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/06',
    );
    ///////////////////////////////////////////////////////////////////
    ...
    if (this.b.err.length > 0) {
      this.logger.logInfo(
        'cd-geo-political-type/CdGeoPoliticalTypeService::validateCreate()/13',
      );
      ret = false;
    }
    return ret;
   ...
   * @param q
   */
  async getCdGeoPoliticalType(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
    ...
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalType/f:',
      q,
    );
    const serviceInput = this.b.siGet(
      q,
      'CdGeoPoliticalTypeService::getCdGeoPoliticalType',
   ...
   * @param q
   */
  async getCdGeoPoliticalTypeStats(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
      q = this.b.getQuery(req);
    }
    ...
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalTypeStats/f:',
      q,
    );
    const serviceInput = this.b.siGet(
      q,
      'CdGeoPoliticalTypeService::getCdGeoPoliticalTypeStats',
      CdGeoPoliticalTypeModel,
    );
    try {
      const r = await this.b.read(req, res, serviceInput);
  ...
  async getCdGeoPoliticalTypeSL(req: Request, res: Response) {
    await this.b.initSqlite(req, res);
    const q = this.b.getQuery(req);
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalTypeSL/q:',
      q,
    );
    const serviceInput = this.b.siGet(
      q,
      'CdGeoPoliticalTypeService::getCdGeoPoliticalTypeSL',
      CdGeoPoliticalTypeModel,
    );
    try {
      this.b.readSL$(req, res, serviceInput).subscribe((r) => {
  ...
  //  * @param res
  //  */
  // getCdGeoPoliticalType(req: Request, res: Response) {
  //     const q = this.b.getQuery(req);
   ...
   * @param res
   */
  getCdGeoPoliticalTypePaged(req: Request, res: Response) {
    const q = this.b.getQuery(req);
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalType/q:',
      q,
  ...
  getPagedSL(req: Request, res: Response) {
    const q = this.b.getQuery(req);
    this.logger.logInfo(
      'CdGeoPoliticalTypeService::getCdGeoPoliticalTypeCount()/q:',
      q,
    );
    const serviceInput = {
      serviceModel: CdGeoPoliticalTypeModel,
  ...
  // getCdGeoPoliticalTypeCount(req: Request, res: Response) {
  //     const q = this.b.getQuery(req);
