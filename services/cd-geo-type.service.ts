...
export class CdGeoTypeService {
  logger: Logging;
  b: BaseService<CdGeoTypeModel>; // instance of BaseService
  cdToken?: string;
  ...
  async create(req: Request, res: Response) {
    ...
    if (await this.validateCreate(req, res)) {
      ...
      this.logger.logInfo(
        'CdGeoTypeService::create()/serviceInput:',
        serviceInput,
      );
  ...
  async createI(
    req,
    res,
    serviceInputExt: IExtServiceInput<CdGeoTypeModel>,
  ): Promise<CdGeoTypeModel | boolean> {
  ...
  async createM(req: Request, res: Response) {
    ...
    for (var CdGeoTypeData of data) {
      ...
      const serviceInputExt: IExtServiceInput<CdGeoTypeModel> = {
        serviceInput: si,
        entityData: CdGeoTypeQuery,
      };
      let ret = await this.createI(req, res, serviceInputExt);
      this.logger.logInfo('CdGeoTypeService::createM()/forLoop/ret:', {
        ret: ret,
      });
    }
  ...
  async CdGeoTypeExists(req, res, params): Promise<any> {
  ...
  async read(
    req,
    res,
    serviceInput: IServiceInput<CdGeoTypeModel>,
  ): Promise<any> {
    // const serviceInput: IServiceInput<CdGeoTypeModel> = {
    //     serviceInstance: this,
    //     serviceModel: CdGeoTypeModel,
  ...
  async validateCreate(req: Request, res: Response) {
    ...
    if (await this.b.validateUnique(req, res, params)) {
      ...
      if (await this.b.validateRequired(req, res, this.cRules)) {
        this.logger.logInfo(
          'cd-geo-type/CdGeoTypeService::validateCreate()/03',
        );
        ret = true;
      } else {
        this.logger.logInfo(
          'cd-geo-type/CdGeoTypeService::validateCreate()/04',
        );
        ret = false;
   ...
   * @param q
   */
  async getCdGeoType(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
   ...
   * @param q
   */
  async getCdGeoTypeStats(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
      q = this.b.getQuery(req);
    }
  ...
  async getCdGeoTypeSL(req: Request, res: Response) {
    await this.b.initSqlite(req, res);
    const q = this.b.getQuery(req);
    if (!q) {
      return;
  ...
  //  * @param res
  //  */
  // getCdGeoType(req: Request, res: Response) {
  //     const q = this.b.getQuery(req);
  //     this.logger.logInfo('CdGeoTypeService::getCdGeoType/f:', q);
  //     const serviceInput = {
  //         serviceModel: CdGeoTypeModel,
   ...
   * @param res
   */
  getCdGeoTypePaged(req: Request, res: Response) {
    const q = this.b.getQuery(req);
    this.logger.logInfo('CdGeoTypeService::getCdGeoType/q:', q);
    const serviceInput = {
      serviceModel: CdGeoTypeModel,
  ...
  // getCdGeoTypeCount(req: Request, res: Response) {
  //     const q = this.b.getQuery(req);
  //     this.logger.logInfo('CdGeoTypeService::getCdGeoTypeCount/q:', q);
  //     const serviceInput = {
  //         serviceModel: CdGeoTypeModel,
