...
export class CdGeoService {
  logger: Logging;
  b: BaseService<CdGeoModel>; // instance of BaseService
  cdToken?: string;
  ...
  async createI(
    req,
    res,
    serviceInputExt: IExtServiceInput<CdGeoModel>,
  ): Promise<CdGeoModel | boolean> {
  ...
  async createM(req: Request, res: Response) {
    ...
    for (var cdGeoData of data) {
      ...
      const serviceInputExt: IExtServiceInput<CdGeoModel> = {
        serviceInput: si,
        entityData: cdGeoQuery,
      };
  ...
  async CdGeoExists(req, res, params): Promise<any> {
  ...
  async read(req, res, serviceInput: IServiceInput<CdGeoModel>): Promise<any> {
    // const serviceInput: IServiceInput<CdGeoModel> = {
    //     serviceInstance: this,
    //     serviceModel: CdGeoModel,
    //     docName: 'CdGeoService::CdGeoExists',
  ...
  async readSL(
    req,
    res,
    serviceInput: IServiceInput<CdGeoModel>,
  ): Promise<any> {
    await this.b.initSqlite(req, res);
  ...
  async validateCreate(req: Request, res: Response) {
    ...
    const pl: CdGeoModel = await this.b.getPlData(req);
    if ('cdGeoTypeId' in pl) {
      ...
      console.log(
        'cd-geo/CdGeoService::validateCreate()/serviceInput:',
   ...
   * @param q
   */
  async getCdGeo(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
   ...
   * @param q
   */
  async getCdGeoStats(req, res, q?: IQuery): Promise<any> {
    if (q === null) {
      q = this.b.getQuery(req);
    }
    if (!q) {
  ...
  async getCdGeoSL(req: Request, res: Response) {
    await this.b.initSqlite(req, res);
    const q = this.b.getQuery(req);
    if (!q) {
      return;
   ...
   * @param res
   */
  getCdGeoPaged(req: Request, res: Response) {
    const q = this.b.getQuery(req);
